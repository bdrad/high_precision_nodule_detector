...
class ResNet(nn.Module):
    ...
    def forward(self, inputs):
        ...
        if self.training:
            ...
            anchors_nms_idx = nms(transformed_anchors[0], scores[0, :, 0], 0.5) #OLD CODE: anchors_nms_idx = nms(torch.cat([transformed_anchors, scores], dim=2)[0, :, :], 0.5)
